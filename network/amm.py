...
from network.cham_unet import CHAMModel
...
class AMM(nn.Module):
    def __init__(self, gate_channels, reduction_ratio=16, pool_types=['avg'], kernel_size=7):
        ...
        self.CHAM = CHAMModel(img_ch=gate_channels, output_ch=gate_channels, mac_pattern=0,
                              mic_pattern=0)
