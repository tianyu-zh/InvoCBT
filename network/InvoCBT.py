...
import network.InvoCBT_cam
class InvoCBT(network.InvoCBT_cam.Net):
    def __init__(self, linear_layer, bilinear, num_classes=4):
        super(InvoCBT, self).__init__(patch_size=16, in_chans=1, channel_ratio=4, embed_dim=384, depth=12,
